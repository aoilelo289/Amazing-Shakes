...
function showEmptyCartNotification() {
    ...
    if (!toast) {
        ...
        toast.innerHTML = `
            ...
            <div class="empty-cart-toast-icon">
                !
            </div>


            <div class="empty-cart-toast-content">

                <div class="empty-cart-toast-title">
                    Your cart is empty
                </div>

                <div class="empty-cart-toast-text">
            ...
            <button
                class="empty-cart-toast-close"
                onclick="closeEmptyCartNotification()">
...
/* =========================
   CLOSE EMPTY CART NOTIFICATION
========================= */

function closeEmptyCartNotification() {
